  ...
  return (
    <div className={`relative ${classBox} `}>
      <div className="select-container relative">
        ...
        {disabled ? <></> :  <div className="arrow-container absolute top-1/2 right-3 pointer-events-none transform -translate-y-1/2">
          <img
        ...
        <label
          ...
          }  ${disabled && '!bg-gradient-to-t from-[#f2f2f2] to-white'}`}
          htmlFor={label}
        >
