...
import ServicerAll from "./Sale-Tab/all";
import ServicerWholeSale from "./Sale-Tab/wholeSale";
import ServicerBreakdown from "./Sale-Tab/breakdown";
import ServicerFronting from "./Sale-Tab/fronting";
import ServicerReInsurance from "./Sale-Tab/reInsurance";
import ServicerReserves from "./Sale-Tab/reserves";
import ServicerBroker from "./Sale-Tab/broker";

function ServicerSale() {
  const getInitialActiveTab = () => {
    const storedTab = localStorage.getItem("ServicerSaleMenu");
  ...
  useEffect(() => {
    localStorage.setItem("ServicerSaleMenu", activeTab);
  }, [activeTab]);
