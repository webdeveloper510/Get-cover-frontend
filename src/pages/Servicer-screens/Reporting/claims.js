...
import ServicerAll from "./Claim-Tab/all";
import ServicerPaidClaim from "./Claim-Tab/paidClaim";
import ServicerUnpaidClaim from "./Claim-Tab/unpaidClaim";

function ServicerClaims() {
