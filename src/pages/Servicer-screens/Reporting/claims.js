...
import ClaimList12 from "../Reporting/Claim-Tab/paidClaim";
import {
  UserDetailAccount,
  checkUserToken,
  downloadFile,
                                        ...
                                        {claimStatus.status == "rejected" ||
                                          ...
                                          >
                                            <Select
                                              ...
                                              white
                                              className1={`!border-0 !text-light-black1 ${repairStatus.status != "servicer_shipped" && 'hidden'}`}
          ...
          <div>
            {totalRecords === 0 && !loaderType ? (
              ...
              <CustomPagination
                ...
                page={pageValue}
                className={loaderType ? "hidden" : "block"}
