  ...
  return (
    <>
      <div className="mb-8 ml-3">
        <div className='bg-white my-8 border-[1px] border-Light-Grey rounded-xl'>
          ...
          <div className=' px-3 mt-5'>
            ...
            <CollapsibleDiv title={<> <Grid className='border-Gray28 border !gap-2 rounded-t-[22px]'>
              ...
              <Grid className='!gap-0 bg-light-black rounded-b-[22px] mb-5 border-Gray28 border-x'>
                ...
                <div className='col-span-2 bg-light-black border-r border-b border-Gray28'>
                  <div className='py-4 pl-3'>
                    <p className='text-white text-[11px] font-Regular'>Service Type</p>
                    <p className='text-[#5D6E66] text-sm font-semibold'>Shipping, Labor</p>
                  </div>
                </div>
                <div className='col-span-8 bg-light-black border-r border-b border-Gray28'>
                  <div className='py-4 pl-3'>
                    <p className='text-white text-[11px] font-Regular'>Description</p>
                ...
                <div className='col-span-12 '>
                  <Grid className=''>
                    <div className='col-span-3 py-4 pl-1 '>
                      <div className='bg-Eclipse py-4 px-2'>
                        ...
                        <p className='text-neutral-grey mb-3 text-[11px] font-Regular'>Servicer Name :   <span className='font-semibold text-white'> Jameson Wills </span></p>
      ...
      <Modal isOpen={isEditOpen} onClose={closeEdit}>
        <Button onClick={closeEdit} className="absolute right-[-13px] top-0 h-[80px] w-[80px] !p-[19px] mt-[-9px] !rounded-full !bg-Granite-Gray">
          <img src={Cross} className="w-full h-full text-black rounded-full p-0" />
        </Button>
        <div className='py-3'>
          <p className='text-center text-3xl font-semibold '>
