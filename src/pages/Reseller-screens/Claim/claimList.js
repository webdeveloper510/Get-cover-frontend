...
function ResellerClaimList(props) {
  ...
  const handleAddClaim = () => {
    if (window.location.pathname.includes("/reseller/claimList")) {
              ...
              <>
                {claimList?.result?.length !== 0 &&
                  <div className="text-right">
                    ...
                    <Button className='!text-sm !ml-3'> <Link to={'/reseller/Reporting/List'}> View Report </Link> </Button>
                  </div>
                }
                {claimList?.result &&
                  claimList?.result?.length !== 0 &&
                                ...
                                <Grid className="!gap-2">
                                  <div className="col-span-4 py-4 pl-1 ">
                                    <div className=" py-2 px-2">
                                      ...
                                      {res?.trackingType == "" && !res.selfServicer ? <></> :
                                        <p className=" mb-4 text-[11px] font-Regular flex self-center">
