        ...
        <div className="py-3">
          ...
          <Grid className="mt-5 px-6">
            ...
            <div className="col-span-12">
              <p className="text-lg  font-semibold">Coverage Type</p>
              <p className="text-base font-bold">
                {dealerPriceBookDetail?.priceBooks?.coverageType &&
                dealerPriceBookDetail?.priceBooks?.coverageType.length > 0 ? (
                  <ol className="flex flex-wrap">
                    {dealerPriceBookDetail?.priceBooks?.coverageType.map(
                      (label, index) => (
                        <li
