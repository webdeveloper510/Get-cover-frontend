...
import {
    ...
    getClaimListAsServicerReseller,
...
function ServicerClaim(props) {
    ...
    const getAllClaims = async (page = 1, rowsPerPage, loader, stemp, id = undefined) => {
        ...
        if (props.flag == 'dealer') {
            getClaimListPromise = getClaimListAsServicer(props.id, data);
        } else {

            getClaimListPromise = getClaimListAsServicerReseller(props.id, data);
        }
