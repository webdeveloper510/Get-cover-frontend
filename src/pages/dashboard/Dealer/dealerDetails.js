...
function DealerDetails() {
  ...
  const getServicerListData = async () => {
    console.log(id.id);
    const result = await getServicerListByDealerId(id.id);
     setRefreshList1(result.data);
  ...
  const tabs = [
    ...
    },
    {
      ...
      content: <ServicerList id={id.id} flag={"servicer"} />,
    },
    {
      id: "Customer",
      label: "Customer",
