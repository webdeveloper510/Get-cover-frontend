                      ...
                      <Grid className="">
                        <div className="col-span-3 py-4 pl-1 ">
                          <div className="bg-[#3C3C3C] py-4 px-2">
                            ...
                            <p className="text-[#999999] mb-3 text-[11px] font-Regular flex self-center">
                              {" "}
                        ...
                        <div className="col-span-4 pt-4">
                          <div className="border border-[#FFFFFF1A] mb-2 p-1 relative rounded-lg flex w-full">
                            ...
                            <div
                              className="self-center ml-auto mr-2 py-3 cursor-pointer h-full"
                          ...
                          <div className="border border-[#FFFFFF1A] mb-2 p-1 relative rounded-lg flex w-full">
                            ...
                            <div
                              className="self-center ml-auto mr-2 cursor-pointer py-3"
                          ...
                          <div className="mt-2">
                            <Button
                              className="!bg-[#fff] !text-light-black !text-[14px] flex"
