...
function AddOrder() {
  ...
  const handleSelectChange2 = async (name, selectedValue) => {
    ...
    if (name.includes("dealerSku")) {
      ...
      handleSelectChange2(
        `productsArray[${productIndex}].priceBookId`,
        data == undefined ? "" : data.priceBookId
      );
    }
  ...
  const getCategoryList = async (value, data, index) => {
    try {
      ...
      if (formikStep3.values.productsArray.length !== 0) {
        ...
        console.log("result.result?.priceBooks", result.result?.priceBooks);
                              ...
                              data.adhDays.map((Data, idx) => (
                                ...
                                >
                                  <div className="pb-3 border-b px-4">
                                    <p className="text-[12px] capitalize"> {Data.label} Waiting </p>
                                    <p className="font-bold text-sm">
                                      {Data.value} Days
                                    </p>
                                  ...
                                  <div className="pt-3 px-4">
                                    <p className="text-[12px] capitalize"> Deductable Amount</p>
                                    <p className="font-bold text-sm">
