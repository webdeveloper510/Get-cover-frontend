...
import {
    ...
    getCustomerData,
    exportDataForClaim,
    getClaimListAsServicer,
    getClaimListAsContract,
...
function ContractClaim(props) {
    ...
    const getAllClaims = async (page = 1, rowsPerPage, loader, stemp, id = undefined) => {
        ...
        if (id == undefined) {
            getClaimListPromise = getClaimListAsContract(props.data?._id, data);
        } else {
            let newData = {
                ...data,
                claimId: id,
            };
            getClaimListPromise = getClaimListAsContract(props.data?._id, newData);
        }
        ...
        <>
            ...
            <div className="mb-8 ml-3">
                <Card className="my-4 pb-4 border-[1px] border-Light-Grey rounded-xl">
                    <div>
                        <p className="text-2xl font-bold">Total Claim Amount :  $
                            {claimList?.claimAmout === undefined
                                ? parseInt(0).toLocaleString(2)
                                : formatOrderValue(claimList?.claimAmout ?? parseInt(0))}</p>
                    </div>
                                ...
                                {claimList?.result &&
                                    ...
                                    claimList?.result?.map((res, index) => {
                                        return (
                                            ...
                                            >
                                                {showdata && (
                                                    <SingleView className=' rounded-b-[22px] mb-5 border-Gray28 border-x'>
                                                                    ...
                                                                    <Grid className="!gap-2">
                                                                        <div className="col-span-4 py-4 pl-1 ">
                                                                            <div className=" py-2 px-2">
                                                                                ...
                                                                                {res?.trackingType == "" && role != "Super Admin" ? '' : <>
                                                                                    <p className=" mb-4 text-[11px] font-Regular flex self-center">
                                                                                                    ...
                                                                                                    >
                                                                                                        <div className="relative flex w-full">
                                                                                                            ...
                                                                                                            <Input
                                                                                                                ...
                                                                                                                // options={state}
                                                                                                                className1="!py-0 !rounded-l-[0px] !border-l-[0px] !text-[13px] !border-1 text-white !bg-Eclipse !font-[400]"
                                                                                                                classBox="w-[50%]"
                                                                                                                ...
                                                                                                                >
                                                                                                                    <div className="relative flex w-full">
                                                                                                                        <Select
                                                                                                                            ...
                                                                                                                            className1="!py-0 !rounded-r-[0px] !text-[13px] !border-1 text-white !bg-Eclipse !font-[400]"
                                                                                                                            classBox="w-[35%]"
                                                                                                                        />
                                                                                                                        <Input
                                                                                                                            name="trackingNumber"
