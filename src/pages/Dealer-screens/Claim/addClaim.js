                      ...
                      <div className="relative">
                        ...
                        {selectedActions[index] && (
                          <div className="absolute z-[2] w-[80px] drop-shadow-5xl -right-3 mt-2 py-3 bg-white border rounded-lg shadow-md top-[1rem]">
                            <div
                              className="text-center py-1 px-2 border-b text-[12px] border-[#E6E6E6] text-light-black cursor-pointer"
                              onClick={nextStep}
                            >
                              <p>Select</p>
                            </div>
                            <div
                              className="text-center py-1 px-2 text-[12px] border-[#E6E6E6] text-light-black cursor-pointer"
                              onClick={() => openModal()}
                            >
                              <p>View</p>
                            </div>
