      ...
      <div className="py-8 pl-3 relative ">
        ...
        <Grid className="!grid-cols-4 mt-5">
          ...
          <div className="col-span-3 max-h-[85vh] pr-3 overflow-y-scroll">
            <Grid className="">
              <div
                className={`${isStatus && resellerStatusMain ? "col-span-10" : "col-span-12"
                  }`}
              >
                <div
                ...
                >
                  ...
                  <div className="absolute h-full right-[5px] flex top-0 self-center">
                    {" "}
                  </div>
                </div>
              </div>
...
export default DealerResellerDetails;
