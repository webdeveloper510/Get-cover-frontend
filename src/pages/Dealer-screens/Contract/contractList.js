            ...
            <>
              {contractList?.result?.length !== 0 &&
                <div className="text-right mt-5">
                  ...
                  <Button className='!text-sm !ml-3'> <Link to={window.location.pathname.includes("/customer/claimList") ? '/customer/Reporting/List' : '/dealer/Reporting/List'}> View Report </Link> </Button>
                </div>}
              {contractList &&
            ...
            !reportSuccess ? (<div>
              ...
              <>
                ...
                <div className="text-center">
                  <Link to={window.location.pathname.includes('customer/claimList') ? "/customer/Reporting/List" : "/dealer/Reporting/List"} className="text-blue-500 hover:underline">
                    Go to Reports Page
                  </Link>
                </div>
              </>
